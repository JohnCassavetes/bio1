...
They are best interpreted as a more honest estimate of transfer difficulty.
...
artifacts currently emphasize the repository baselines; extending the same
external comparison to the literature baselines would strengthen the transfer
story further. Repeated-seed results and confidence intervals would also
improve the statistical presentation. Venue-specific formatting, references,
and a finalized author list are still needed. These are polishing or
strengthening steps rather than core benchmark blockers.
